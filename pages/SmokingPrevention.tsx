...
export default function SmokingPrevention() {
  ...
  const tabs = [
    { id: 'tab-0', title: 'Курение и ответственность. Важно знать!', content: `<p><img class="w-full h-auto rounded-2xl shadow-md hover:shadow-xl hover:scale-105 transition-all duration-300 object-cover" alt=""  src="/images/1Novosti/2024/Aprel/Kurenie.png"  /></p>
